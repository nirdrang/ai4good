...
Work read-only in the repository at /home/user/ai4good. Write your full findings to loop/items/AI4DEV-55/artifacts/how/critic-grok.md; that is the only file you create or change. Then reply with exactly five lines: the output path, then four lines naming your most severe findings.
