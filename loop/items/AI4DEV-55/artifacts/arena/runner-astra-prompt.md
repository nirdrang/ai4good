# Architect runner: direction C (catalog-first)

You are one of four parallel design runners. Read `loop/items/AI4DEV-55/artifacts/arena/design-task.md` in full first; it names the grounding to read, the constraints, the four directions, and what the package must contain. YOUR ASSIGNED DIRECTION IS **C, catalog-first**. Design the best version of that direction and do not drift toward the others.
