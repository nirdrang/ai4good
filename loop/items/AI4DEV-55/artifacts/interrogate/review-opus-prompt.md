...
Work read-only in the repository at /home/user/ai4good except for ONE file: write your complete findings to `loop/items/AI4DEV-55/artifacts/interrogate/review-opus.md`. Then reply with exactly five lines: the output path, then four lines naming your most severe findings (or 'no findings').
