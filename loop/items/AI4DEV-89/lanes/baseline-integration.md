# Integration baseline at unit 2 start

Commit: cfb74a6 AI4DEV-89: the local stack drops a crash-looping log shipper. This is the second attempt, after the edge runtime container was started by hand.

## Container state

Step 1 (`docker ps --filter 'name=poancmeitlmxejofwzuu'`, before req-016):
```
supabase_db_poancmeitlmxejofwzuu Up 2 minutes (healthy)
supabase_studio_poancmeitlmxejofwzuu Up 2 minutes (healthy)
supabase_pg_meta_poancmeitlmxejofwzuu Up 2 minutes (healthy)
supabase_edge_runtime_poancmeitlmxejofwzuu Up 36 seconds
supabase_storage_poancmeitlmxejofwzuu Up 2 minutes (healthy)
supabase_rest_poancmeitlmxejofwzuu Up 2 minutes
supabase_realtime_poancmeitlmxejofwzuu Up 2 minutes (healthy)
supabase_inbucket_poancmeitlmxejofwzuu Up 2 minutes (healthy)
supabase_auth_poancmeitlmxejofwzuu Up 2 minutes (healthy)
supabase_kong_poancmeitlmxejofwzuu Up 2 minutes (healthy)
```

Step 3 (`docker ps -a --filter 'name=supabase_edge_runtime_poancmeitlmxejofwzuu'`, after req-016):
```
Up About a minute
```
No restart was needed between req-016 and req-001.

Step 5 (`docker ps -a --filter 'name=supabase_edge_runtime_poancmeitlmxejofwzuu'`, after req-001):
```
Up 5 minutes
```
No restart was needed after req-001.
...
at:verify — stack poancmeitlmxejofwzuu (api 44321) — reset OK — migrations: 15 expected, 15 applied — lock C:\Users\nirdr\AppData\Local\ai4good-build\at-locks\at-verify-poancmeitlmxejofwzuu-44321.lock — head cfb74a6, dirty
JSON report written to C:/Users/nirdr/AppData/Local/Temp/at-verify-wlO2za/vitest-report.json
...
at:verify — 15 migrations expected, 15 applied — the rebuilt schema matches supabase/migrations exactly
at:verify — stack poancmeitlmxejofwzuu (api 44321) — reset OK — migrations: 15 expected, 15 applied — lock C:\Users\nirdr\AppData\Local\ai4good-build\at-locks\at-verify-poancmeitlmxejofwzuu-44321.lock — head cfb74a6, dirty
JSON report written to C:/Users/nirdr/AppData/Local/Temp/at-verify-hr0mZ8/vitest-report.json
