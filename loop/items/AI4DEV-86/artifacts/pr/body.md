...
On the clean tree at head 37db48b (the code head 77f3768 plus the item record; transcript rtifacts/verify4/transcript.md): the integration tier matched again with the evidence line ... — head 37db48b and no dirty flag, and the live drive passed 11 of 11 on the same head.
