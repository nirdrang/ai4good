...
Write your findings to loop/items/AI4DEV-86/artifacts/how/critic-fable.md (create it; this is the one file you may write). Reply with only a two-line summary. Do not modify any other file.