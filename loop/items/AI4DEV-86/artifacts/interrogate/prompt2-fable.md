...
## Where to write
Write your findings to loop/items/AI4DEV-86/artifacts/interrogate/review2-fable.md (create it; the one file you may write). Reply with a two-line summary only.