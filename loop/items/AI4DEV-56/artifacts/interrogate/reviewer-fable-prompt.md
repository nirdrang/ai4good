...
You are read-only. Do not run git write commands, do not start processes, do not touch the database, do not write any file. Your sandbox may refuse writes; deliver the WHOLE review as your final message, because the launcher saves only your final message to loop/items/AI4DEV-56/artifacts/interrogate/review-fable.md.
