...
Write your design package to loop/items/AI4DEV-56/artifacts/arena/candidate-astra.md. You are read-only everywhere else: do not run git, do not start processes, do not touch the database, do not modify any other file.
