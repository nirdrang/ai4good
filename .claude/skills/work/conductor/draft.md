# The draft phase — the item's longest wait
...
single phase routinely runs longer than the rest of the item put together. You hold no timer, no
budget and no alarm; the sitting's ending is your wake. A quiet hour here is the design working,
not a fault. If the founder asks, answer from the status log.

Nothing else happens in this phase. You spawn nothing else, arm nothing, and send nothing between
your flow lines.
