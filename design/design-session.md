...
8. **Close.** Commit (`design-batch-N: AI4DEV-nnn …` — the batch's DEV-board item ID rides
   every design commit; batches live on the engineering board, d87), append a design-log entry
