...
- Handoff + health: requested / accepted / rejected → NGO + volunteer (rejected adds admin); verification outcome → NGO. (The 60-day jumpstart email moved to v1.5 with the health layer — decision-26/c8.)
