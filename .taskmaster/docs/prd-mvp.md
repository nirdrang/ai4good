...
- The volunteer browses public listings and marks candidacies; the first candidacy starts the project's time-based assimilation window (further candidates shrink it), and at lapse the concierge matches from the pool (decision-36).
