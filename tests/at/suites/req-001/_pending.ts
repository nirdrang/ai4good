/**
 * THE IDS REQ-001 HAS NOT LANDED YET, and the leaf that will land each one. There are 6 of them
 * once the contact-transfer leaf is in this tree. There were 11 before that, 14 before that, 16
 * before that, 24 before the three earlier leaves, 28 before that, 30 before that and 33 before
 * that, and the count moves down as leaves land.
 *
 ...
 * sites; there is no partial suite. Thirty-one are written — AT-001.01 through .07 across the first
 ...
 * AT-001.23, .40 and .24 with the assigned-volunteer-scope one, and AT-001.25, .26, .27, .28 and
 * .35 with the contact-transfer one. The other 6 are declared, not faked: each one throws, loudly,
 ...
 */
export const LEAF = {
  // NINE LABELS ARE GONE FROM THIS MAP rather than kept for symmetry, and the rule is the same
  // for all nine: a leaf label sitting here with nothing pointing at it is a claim that something
